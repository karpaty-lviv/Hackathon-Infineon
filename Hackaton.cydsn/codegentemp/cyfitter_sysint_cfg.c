...
/* ARM CM4 */
    ...
    /* IR_SCB_IRQ */
    const cy_stc_sysint_t IR_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)IR_SCB_IRQ__INTC_NUMBER,
        .intrPriority = IR_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };

    /* I2C_Main_SCB_IRQ */
    const cy_stc_sysint_t I2C_Main_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)I2C_Main_SCB_IRQ__INTC_NUMBER,
        .intrPriority = I2C_Main_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };
    ...
    /* SPI_LEDCTRL_SCB_IRQ */
    const cy_stc_sysint_t SPI_LEDCTRL_SCB_IRQ_cfg = {
        .intrSrc = (IRQn_Type)SPI_LEDCTRL_SCB_IRQ__INTC_NUMBER,
        .intrPriority = SPI_LEDCTRL_SCB_IRQ__INTC_CORTEXM4_PRIORITY
    };
