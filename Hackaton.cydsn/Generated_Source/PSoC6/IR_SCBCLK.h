...
*
* \brief
* Provides the source code to the API for the IR_SCBCLK Component.
*
********************************************************************************
* \copyright
...
#if !defined(CY_IR_SCBCLK_NAME_IR_SCBCLK_H)
#define CY_IR_SCBCLK_NAME_IR_SCBCLK_H
...
#define IR_SCBCLK_DIV_NUM ((uint32_t)IR_SCBCLK__DIV_NUM)
/** The peripheral clock divider type */
#define IR_SCBCLK_DIV_TYPE ((cy_en_divider_types_t)IR_SCBCLK__DIV_TYPE)
/** @} group_macros */
...
/*******************************************************************************
* Function Name: IR_SCBCLK_Enable
****************************************************************************//**
*
...
*
*******************************************************************************/
__STATIC_INLINE void IR_SCBCLK_Enable(void)
{
    (void)Cy_SysClk_PeriphEnableDivider(IR_SCBCLK_DIV_TYPE, IR_SCBCLK_DIV_NUM);
}

/*******************************************************************************
* Function Name: IR_SCBCLK_Disable
****************************************************************************//**
*
...
*
*******************************************************************************/
__STATIC_INLINE void IR_SCBCLK_Disable(void)
{
    (void)Cy_SysClk_PeriphDisableDivider(IR_SCBCLK_DIV_TYPE, IR_SCBCLK_DIV_NUM);
}

/*******************************************************************************
* Function Name: IR_SCBCLK_SetDivider
****************************************************************************//**
*
* Sets the value of a programmable clock divider assigned to this Component.
* This is only used for integer dividers. Use IR_SCBCLK_SetFracDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void IR_SCBCLK_SetDivider(uint32_t dividerValue)
{
    (void)Cy_SysClk_PeriphSetDivider(IR_SCBCLK_DIV_TYPE, IR_SCBCLK_DIV_NUM, dividerValue);
}

/*******************************************************************************
* Function Name: IR_SCBCLK_GetDivider
****************************************************************************//**
*
...
* Use IR_SCBCLK_GetFracDivider() with a fractional divider.
*
* \param None
*
* \return
...
*
*******************************************************************************/
__STATIC_INLINE uint32_t IR_SCBCLK_GetDivider(void)
{
    return Cy_SysClk_PeriphGetDivider(IR_SCBCLK_DIV_TYPE, IR_SCBCLK_DIV_NUM);
}

/*******************************************************************************
* Function Name: IR_SCBCLK_SetFracDivider
****************************************************************************//**
*
* Sets the values of a programmable clock divider assigned to this Component.
* This is only used for fractional dividers. Use IR_SCBCLK_SetDivider()
...
*
*******************************************************************************/
__STATIC_INLINE void IR_SCBCLK_SetFracDivider(uint32_t dividerIntValue, uint32_t dividerFracValue)
{
    (void)Cy_SysClk_PeriphSetFracDivider(IR_SCBCLK_DIV_TYPE, IR_SCBCLK_DIV_NUM, dividerIntValue, dividerFracValue);
}

/*******************************************************************************
* Function Name: IR_SCBCLK_GetFracDivider
****************************************************************************//**
*
...
* Use IR_SCBCLK_GetDivider() with an integer divider.
*
* \param *dividerIntValue
...
*
*******************************************************************************/
__STATIC_INLINE void IR_SCBCLK_GetFracDivider(uint32_t *dividerIntValue, uint32_t *dividerFracValue)
{
    Cy_SysClk_PeriphGetFracDivider(IR_SCBCLK_DIV_TYPE, IR_SCBCLK_DIV_NUM, dividerIntValue, dividerFracValue);
}

/** @} general */

#endif /* CY_CLOCK_IR_SCBCLK_H */
