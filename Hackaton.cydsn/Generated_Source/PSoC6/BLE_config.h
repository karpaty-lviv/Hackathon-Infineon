...
#define CY_BLE_CONFIG_MAX_WHITE_LIST_SIZE           (4u)
...
<<<<<<< HEAD
#define CY_BLE_ADV_PKT_0_INDEX_TX_POWER_LEVEL   (0x0Au)
#define CY_BLE_ADV_PKT_0_INDEX_APPEARANCE   (0x0Du)
#define CY_BLE_ADV_PKT_0_INDEX_ADVERTISING_INTERVAL   (0x11u)
=======
#define CY_BLE_ADV_PKT_0_INDEX_TX_POWER_LEVEL   (0x0Cu)
#define CY_BLE_ADV_PKT_0_INDEX_APPEARANCE   (0x0Fu)
#define CY_BLE_ADV_PKT_0_INDEX_ADVERTISING_INTERVAL   (0x13u)
>>>>>>> bd22d50f3383c241732a6171578cebde1d55ad66
#define CY_BLE_SCN_PKT_0_INDEX_MANUFACTURER_DATA   (0x00u)
 ...
 */
#define CY_BLE_CONFIG_GATT_MTU                      (0x00FFu)

/** The GATT Maximum attribute length. */
#define CY_BLE_CONFIG_GATT_DB_MAX_VALUE_LEN         (0x00C8u)
...
#define CY_BLE_CONFIG_L2CAP_ENABLE                  (1u)
    ...
    /** L2CAP MTU Size. */
    #define CY_BLE_CONFIG_L2CAP_MTU                     (251u)
 ...
 */
#define CY_BLE_NUS_UART_SERVICE_INDEX   (0x00u) /* Index of NUS UART service in the cy_ble_customs array */
#define CY_BLE_NUS_UART_NUS_RX_CHAR_INDEX   (0x00u) /* Index of NUS RX characteristic */
#define CY_BLE_NUS_UART_NUS_TX_CHAR_INDEX   (0x01u) /* Index of NUS TX characteristic */
#define CY_BLE_NUS_UART_NUS_TX_TX_CCCD_DESC_INDEX   (0x00u) /* Index of TX_CCCD descriptor */


#define CY_BLE_NUS_UART_SERVICE_HANDLE   (0x0010u) /* Handle of NUS UART service */
#define CY_BLE_NUS_UART_NUS_RX_DECL_HANDLE   (0x0011u) /* Handle of NUS RX characteristic declaration */
#define CY_BLE_NUS_UART_NUS_RX_CHAR_HANDLE   (0x0012u) /* Handle of NUS RX characteristic */
#define CY_BLE_NUS_UART_NUS_TX_DECL_HANDLE   (0x0013u) /* Handle of NUS TX characteristic declaration */
#define CY_BLE_NUS_UART_NUS_TX_CHAR_HANDLE   (0x0014u) /* Handle of NUS TX characteristic */
#define CY_BLE_NUS_UART_NUS_TX_TX_CCCD_DESC_HANDLE   (0x0015u) /* Handle of TX_CCCD descriptor */
